...
void test_validate_my_username()
{
     ...
     */
     ...
     char* readback_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(expected_username, readback_username,
    "Your username from /conf/username.txt does not match my_username()");
}
